...
//		GrailsStatelessService
    ...
    ParameterName
    PropertyName
    // Complains that final fields should be in all upper case where as that should only be
    // for final class fields, not final instance fields.
//		VariableName

    // rulesets/security.xml
    FileCreateTempFile
    InsecureRandom
    // Complains about usage of Java IO package. WTH?
//		JavaIoPackageAccess
    NonFinalPublicField
